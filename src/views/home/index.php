...
<header>
    <nav class="header-nav">
        <img alt="logo" src="uploads/logo_nova_grande.png" class="logo">
        <p><a href="#">Passagens</a></p>
        <p><a href="#">Novo!</a></p>
        <p><a href="#">Hotel</a></p>
        <button class="btn-login">Login</button>
        <button class="btn-ajuda">Ajuda</button>
        <div><img alt="ajuda" src="uploads/icon_atendimento-online_ajuda.svg"></div>
    </nav>
</header>
...
<?php
// Limpa cache manualmente via ?limpar_cache=1
if (isset($_GET['limpar_cache'])) {
    unset($_SESSION['viacoes_cache'], $_SESSION['viacoes_cache_ts']);
    header('Location: home.php');
    exit;
...
<div>
                ...
                <div>
                    <form class="form">
                        ...
                        <div class="form-group">
                            ...
                            <input id="dataida" type="date" placeholder="09/04/2026">
                        </div>
                        <div class="form-group">
                            <label for="datavolta">Data Volta</label>
                            <input id="datavolta" type="date" placeholder="D">
                        </div>
                        <div>
    ...
    <div class="conteudo_principal">
        <main>
            <!--linha abaixo da imagem quero passagem-->
            ...
            <section class="destinos">
                ...
                <p class="destinos-subtitulo">São mais de 5mil destinos em todo o país para escolher sem sair de
                    casa!</p>
                <div class="destinos-grid">

                    <div class="destino-card">
                        <img src="uploads/1a.jpg" alt="São Paulo">
                        <h3>São Paulo</h3>
                    </div>

                    <div class="destino-card">
                        <img src="uploads/57a.jpg" alt="Rio de Janeiro">
                        <h3>Rio de Janeiro</h3>
                    </div>

                    <div class="destino-card">
                        <img src="uploads/55a.jpg" alt="Curitiba">
                        <h3>Curitiba</h3>
                    </div>

                    <div class="destino-card">
                        <img src="uploads/64a.jpg" alt="Belo Horizonte">
...
<!--top 15 trechos de onibus-->
<div class="mais-procurados section section--bg-page">
...
<!--e e-mails com novidade QRcode e app-->
<section class="app">
    <!--qrcode do app + imagem-->
    <div>
        <div class="banner-qr">
            <img src="uploads/banner_download_app_2.png">
        </div>
    </div>
</section>
<!--seja um parceiro-->
<div class="parceiros">
    <img src="uploads/parceiro.png" width="575px" height="290px">
    <div class="parceiro-direita">
        <div class="parceiro_vantagens">
            <!--imagem -->
            <span class="Parceiro-title">Agências de viagens</span> <br>
            <span class="parceiro-texto">Sistema completo de emissão e venda de passagens rodoviárias para agências de viagens.</span>
        </div>
        <div class="parceiro_vantagens">
            <!--imagem -->
            <span class="Parceiro_title">OTA's</span> <br>
...
<div class="sobre">
    <div class="cards-grid">
        ...
        <div class="card">
            <div><img src="uploads/card_pagamento.png" alt="cartoes"></div>
        ...
        <div class="card">
            <div>
                <img src="uploads/card_onibus.png" alt="cartoes"></div>
        ...
        <div class="card">
            <div>
                <img src="uploads/card_bilhetes.png" alt="cartoes"></div>
            Na Quero Passagem, você escolhe o horário, o assento e a empresa favorita para viajar.
            Finalize sua compra de passagem rodoviária online de forma rápida, segura e sem
            complicação.
        </div>

        <div class="card">
            <div>
                <img src="uploads/card_praia.png" alt="cartoes"></div>
    ...
    <details>
        <summary>Qual limite de peso e com quantas bagagens eu posso embarcar na minha viagem de ônibus?
        </summary>
...
<footer class="footer">
    ...
    <div class="footer-corpo">
        <img src="uploads/logo_nova_grande.png" alt="logo">
        ...
        <div class="footer-links">
            ...
            <ul>
                ...
                <li>Rodomilhas</li>
                <li>Viajo Mucho</li>
                <li>La termilnal Costa Rica</li>
            </ul>
        </div>

    </div>

    <div class="footer-sociais-wrapper">
        <div class="direita">
            <div>Siga nossas redes Sociais</div>
            <div class="footer-sociais">
                <a href="https://www.instagram.com/queropassagem" target="_blank"></a>
                <i class="uil uil-linkedin"></i>
                <a href="https://www.youtube.com/channel/UCV9uFupk50da_JOeooO5KSA" target="_blank"></a>
                <a href="https://www.linkedin.com/company/queropassagem/" target="_blank"></a>
            </div>
        </div>
        <div class="esquerda">
